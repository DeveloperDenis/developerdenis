...
int main(int argc, char** argv)
{
    ...
    XStoreName(display, window, STATIC_SETTINGS::WINDOW_TITLE);
	...
	real64 secondsPerFrame = (real64)1/(real64)STATIC_SETTINGS::FPS_TARGET;
	uint64 nanoSecondsPerFrame = (uint64)(secondsPerFrame*1000000000L);
    ...
    while(running)
    {
		...
		while ((uint64)nanoDiff < nanoSecondsPerFrame)
		{
